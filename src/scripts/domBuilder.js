const domBuilder = {
    appendInputForm () {
        ...
        <input id="lego__name" name="lego__creator" type="text" autofocus />
        </fieldset>

        <article>
        <fieldset>
        <label for="lego__shape">Shape:</label>
        <input id="lego__shape" name="lego__creator" type="text" autofocus />
        </fieldset>

        <fieldset>
        <label for="lego__color">Color:</label>
        <input id="lego__color" name="lego__creator" type="text" autofocus />
        </fieldset>
